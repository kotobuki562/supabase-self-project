    ...
    <div className="w-full text-right">
      <Menu as="div" className="relative inline-block text-left">
        {({ open }) => (
          <>
            <div>
              <Menu.Button className="inline-flex justify-center w-12 h-12 sm:w-20 sm:h-20">
              ...
              >
                <div className="px-1 py-1 ">
                  <Menu.Item>
                    {({ active }) => (
                      <button
                        ...
                        className="group flex rounded-md items-center w-full px-2 py-2 text-sm hover:text-darkSushi dark:hover:text-sushi"
                      >
                        {active ? (
                          <EditActiveIcon
                  ...
                  <Menu.Item>
                    {({ active }) => (
                      <button
                        onClick={() => router.push("/emojis/create")}
                        className="group flex rounded-md items-center w-full px-2 py-2 text-sm hover:text-darkSushi dark:hover:text-sushi"
                      >
                        {active ? (
                          <ArchiveActiveIcon
